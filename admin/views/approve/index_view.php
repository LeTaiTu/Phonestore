                          ...
                          <?php if(!empty($dataAll)): ?>
                            <?php foreach($dataAll as $key => $item):?>
                              ...
                              <tr>
                                ...
                                <td style="text-align: center"><a href="home.php?sk=duyetdon&m=nextstep&idorder=<?php echo $item['id']?>&id=<?php echo $item['order_status']?>" class="btn btn-warning">
                                  <?php if($item['order_status']==0){ echo "Click nhận đơn";}
                                        if($item['order_status']==1){echo "Click gửi hàng";}
                                        if($item['order_status']==2){ echo "Đã xong đơn";}
                                  ?>
                                  </a></td>  
                              </tr>
                            <?php endif?>
